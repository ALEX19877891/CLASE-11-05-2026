...
a variable resultado en 1, porque es el valor neutro de la multiplicación.
Repite el proceso la cantidad de veces indicada.
Multiplica el resultado por el número en cada repetición.
